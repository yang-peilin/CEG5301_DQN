...
class FrameStack(gym.Wrapper):
    def __init__(self, env, k):
        ...
        self.k = k
        # create the deque ("double-ended queues") data type to store the most recent image frames and angular velocities.
    ...
    def reset(self):
        ...
        ob, _ = self.env.reset()
        # make copies to the fill the double queues
    ...
    def step(self, action):
        ...
        # Keep appending the latest image and angular velocity to the self.frames and self.states, respectively.
        self.frames.append(ob[0])
        self.states.append(ob[1])
